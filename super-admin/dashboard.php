...
$username_login = $_SESSION['cusername'];

$query = "SELECT * FROM super_admin WHERE email='$username_login'";
               ...
               <div class="profile-desc">
                  <div class="profile-pic">
                     ...
                     <div class="profile-name">
                        <h5 class="mb-0 font-weight-normal">PEDDLER</h5>
            ...
            <li class="nav-item menu-items">
               ...
               <div class="collapse" id="ui-basic">
                  <ul class="nav flex-column sub-menu">
                     <li class="nav-item"> <a class="nav-link" href="add.php">Add Admin</a></li>
                     <li class="nav-item"> <a class="nav-link" href="total-user.php">View Admin</a></li>
                  </ul>
               </div>
            </li>
            <li class="nav-item menu-items">
